...
window::window(QWidget *parent) :
    ...
    ui(new Ui::window)
{
    setWindowIcon(QIcon(":/images/pacman.ico"));
    score=0;
    gosx=450/2;
    gosy=480/2;
    gosx1=450/2;
    ...
    b1=new easyMusic("sounds/bs1.wav",70,1);
    b2=new easyMusic("sounds/bs2.wav",70,1);
    b3=new easyMusic("sounds/bs3.wav",70,1);
    e1=new easyMusic("sounds/endmusic1.wav",70,1);
    e2=new easyMusic("sounds/endmusic2.wav",70,1);
    ...
    anime = new animation;
    scene->addItem(anime);
    animetimer = new QTimer(this);
    connect(animetimer,SIGNAL(timeout()),this,SLOT(animeupdater()));
    animetimer->start(1000);
...
void window::start_Game()
{
    ...
    //powerball->setplus(Powerballpoints);
...
void window::animeupdater()
{
    anime->advance();
    scene->update(anime->boundingRect());
}
